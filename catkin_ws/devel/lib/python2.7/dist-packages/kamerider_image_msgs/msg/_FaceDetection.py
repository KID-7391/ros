...
"""autogenerated by genpy from kamerider_image_msgs/FaceDetection.msg. Do not edit."""
import sys
...
class FaceDetection(genpy.Message):
  _md5sum = "1261acd8bc8bd6463d06589c0438ae60"
  _type = "kamerider_image_msgs/FaceDetection"
...
"""
  __slots__ = ['header','image_header','face_num','bounding_boxes']
  _slot_types = ['std_msgs/Header','std_msgs/Header','int8','kamerider_image_msgs/BoundingBox[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,image_header,face_num,bounding_boxes
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_b().pack(self.face_num))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.face_num,) = _get_struct_b().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.bounding_boxes = []
      for i in range(0, length):
        val1 = kamerider_image_msgs.msg.BoundingBox()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
