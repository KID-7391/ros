...
"""autogenerated by genpy from face_detection/FaceRecognitionTrainRequest.msg. Do not edit."""
import sys
...
class FaceRecognitionTrainRequest(genpy.Message):
  ...
  _type = "face_detection/FaceRecognitionTrainRequest"
...
"""
  ...
  _slot_types = ['sensor_msgs/Image[]','face_detection/Rect[]','string[]']
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from face_detection/FaceRecognitionTrainResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class FaceRecognitionTrainResponse(genpy.Message):
  ...
  _type = "face_detection/FaceRecognitionTrainResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """bool ok
string error
...
class FaceRecognitionTrain(object):
  _type          = 'face_detection/FaceRecognitionTrain'
