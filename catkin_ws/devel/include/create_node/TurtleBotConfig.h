...
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(TurtleBotConfig::AbstractParamDescriptionConstPtr(new TurtleBotConfig::ParamDescription<std::string>("drive_mode", "str", 0, "The possible drive modes (twist, turtle, drive).", "{'enum_description': '', 'enum': [{'srcline': 10, 'description': 'Takes a geometry_msgs/Twist message and is navigation compatible.', 'srcfile': '/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'cconsttype': 'const char * const', 'value': 'twist', 'ctype': 'std::string', 'type': 'str', 'name': 'twist'}, {'srcline': 11, 'description': 'Takes a create_node/Turtle message and is turtlesim compatible.', 'srcfile': '/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'cconsttype': 'const char * const', 'value': 'turtle', 'ctype': 'std::string', 'type': 'str', 'name': 'turtle'}, {'srcline': 12, 'description': 'Takes a create_node/Drive message which drives the TurtleBot as described in the iRobot Create manual.', 'srcfile': '/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'cconsttype': 'const char * const', 'value': 'drive', 'ctype': 'std::string', 'type': 'str', 'name': 'drive'}]}", &TurtleBotConfig::drive_mode)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(TurtleBotConfig::AbstractParamDescriptionConstPtr(new TurtleBotConfig::ParamDescription<double>("gyro_measurement_range", "double", 0, "Measurement range supported by gyro.", "{'enum_description': 'Gyro Options', 'enum': [{'srcline': 24, 'description': 'ADXRS613 150deg/s', 'srcfile': '/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'cconsttype': 'const double', 'value': 150.0, 'ctype': 'double', 'type': 'double', 'name': 'ADXRS613'}, {'srcline': 25, 'description': 'ADXRS652 250deg/s', 'srcfile': '/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'cconsttype': 'const double', 'value': 250.0, 'ctype': 'double', 'type': 'double', 'name': 'ADXRS652'}, {'srcline': 26, 'description': 'ADXRS642 300deg/s', 'srcfile': '/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'cconsttype': 'const double', 'value': 300.0, 'ctype': 'double', 'type': 'double', 'name': 'ADXRS642'}]}", &TurtleBotConfig::gyro_measurement_range)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(TurtleBotConfig::AbstractParamDescriptionConstPtr(new TurtleBotConfig::ParamDescription<double>("gyro_measurement_range", "double", 0, "Measurement range supported by gyro.", "{'enum_description': 'Gyro Options', 'enum': [{'srcline': 24, 'description': 'ADXRS613 150deg/s', 'srcfile': '/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'cconsttype': 'const double', 'value': 150.0, 'ctype': 'double', 'type': 'double', 'name': 'ADXRS613'}, {'srcline': 25, 'description': 'ADXRS652 250deg/s', 'srcfile': '/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'cconsttype': 'const double', 'value': 250.0, 'ctype': 'double', 'type': 'double', 'name': 'ADXRS652'}, {'srcline': 26, 'description': 'ADXRS642 300deg/s', 'srcfile': '/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'cconsttype': 'const double', 'value': 300.0, 'ctype': 'double', 'type': 'double', 'name': 'ADXRS642'}]}", &TurtleBotConfig::gyro_measurement_range)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 10 "/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg"
      const char * const TurtleBot_twist = "twist";
//#line 11 "/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg"
      const char * const TurtleBot_turtle = "turtle";
//#line 12 "/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg"
      const char * const TurtleBot_drive = "drive";
//#line 24 "/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg"
      const double TurtleBot_ADXRS613 = 150.0;
//#line 25 "/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg"
      const double TurtleBot_ADXRS652 = 250.0;
//#line 26 "/home/wen/rse/catkin_ws/src/turtlebot_create/create_node/cfg/TurtleBot.cfg"
