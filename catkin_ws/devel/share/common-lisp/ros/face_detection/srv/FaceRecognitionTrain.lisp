...
(cl:defclass <FaceRecognitionTrain-request> (roslisp-msg-protocol:ros-message)
  ((images
   ...
   (rects
    :reader rects
    :initarg :rects
    :type (cl:vector face_detection-msg:Rect)
   :initform (cl:make-array 0 :element-type 'face_detection-msg:Rect :initial-element (cl:make-instance 'face_detection-msg:Rect)))
   (labels
    :reader labels
    :initarg :labels
...
(cl:defmethod cl:initialize-instance :after ((m <FaceRecognitionTrain-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FaceRecognitionTrain-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name face_detection-srv:<FaceRecognitionTrain-request> is deprecated: use face_detection-srv:FaceRecognitionTrain-request instead.")))

(cl:ensure-generic-function 'images-val :lambda-list '(m))
(cl:defmethod images-val ((m <FaceRecognitionTrain-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detection-srv:images-val is deprecated.  Use face_detection-srv:images instead.")
  (images m))

(cl:ensure-generic-function 'rects-val :lambda-list '(m))
(cl:defmethod rects-val ((m <FaceRecognitionTrain-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detection-srv:rects-val is deprecated.  Use face_detection-srv:rects instead.")
  (rects m))

(cl:ensure-generic-function 'labels-val :lambda-list '(m))
(cl:defmethod labels-val ((m <FaceRecognitionTrain-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detection-srv:labels-val is deprecated.  Use face_detection-srv:labels instead.")
  (labels m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <FaceRecognitionTrain-request>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'rects)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'face_detection-msg:Rect))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FaceRecognitionTrain-request>)))
  ...
  "face_detection/FaceRecognitionTrainRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FaceRecognitionTrain-request)))
  "Returns string type for a service object of type 'FaceRecognitionTrain-request"
  "face_detection/FaceRecognitionTrainRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <FaceRecognitionTrain-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FaceRecognitionTrain-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name face_detection-srv:<FaceRecognitionTrain-response> is deprecated: use face_detection-srv:FaceRecognitionTrain-response instead.")))

(cl:ensure-generic-function 'ok-val :lambda-list '(m))
(cl:defmethod ok-val ((m <FaceRecognitionTrain-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detection-srv:ok-val is deprecated.  Use face_detection-srv:ok instead.")
  (ok m))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <FaceRecognitionTrain-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detection-srv:error-val is deprecated.  Use face_detection-srv:error instead.")
  (error m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FaceRecognitionTrain-response>)))
  ...
  "face_detection/FaceRecognitionTrainResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FaceRecognitionTrain-response)))
  "Returns string type for a service object of type 'FaceRecognitionTrain-response"
  "face_detection/FaceRecognitionTrainResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FaceRecognitionTrain)))
  ...
  "face_detection/FaceRecognitionTrain")