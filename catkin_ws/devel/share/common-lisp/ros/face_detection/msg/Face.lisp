...
(cl:defclass <Face> (roslisp-msg-protocol:ros-message)
  ((face
    :reader face
    :initarg :face
    :type face_detection-msg:Rect
    :initform (cl:make-instance 'face_detection-msg:Rect))
   (eyes
    :reader eyes
    :initarg :eyes
...
(cl:defmethod face-val ((m <Face>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detection-msg:face-val is deprecated.  Use face_detection-msg:face instead.")
  (face m))
...
(cl:defmethod label-val ((m <Face>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detection-msg:label-val is deprecated.  Use face_detection-msg:label instead.")
  (label m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <Face>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detection-msg:confidence-val is deprecated.  Use face_detection-msg:confidence instead.")
  (confidence m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Face>)))
  ...
  (cl:format cl:nil "Rect face~%Rect[] eyes~%string label~%float64 confidence~%~%================================================================================~%MSG: face_detection/Rect~%# opencv Rect data type, x-y is center point~%float64 x~%float64 y~%float64 width~%float64 height~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Face)))
  "Returns full string definition for message of type 'Face"
  (cl:format cl:nil "Rect face~%Rect[] eyes~%string label~%float64 confidence~%~%================================================================================~%MSG: face_detection/Rect~%# opencv Rect data type, x-y is center point~%float64 x~%float64 y~%float64 width~%float64 height~%~%~%~%"))
