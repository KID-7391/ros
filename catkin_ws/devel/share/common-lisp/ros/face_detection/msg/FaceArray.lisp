...
(cl:defmethod cl:initialize-instance :after ((m <FaceArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FaceArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name face_detection-msg:<FaceArray> is deprecated: use face_detection-msg:FaceArray instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FaceArray>)))
  ...
  (cl:format cl:nil "Face[] faces~%~%~%================================================================================~%MSG: face_detection/Face~%Rect face~%Rect[] eyes~%string label~%float64 confidence~%~%================================================================================~%MSG: face_detection/Rect~%# opencv Rect data type, x-y is center point~%float64 x~%float64 y~%float64 width~%float64 height~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FaceArray)))
  "Returns full string definition for message of type 'FaceArray"
  (cl:format cl:nil "Face[] faces~%~%~%================================================================================~%MSG: face_detection/Face~%Rect face~%Rect[] eyes~%string label~%float64 confidence~%~%================================================================================~%MSG: face_detection/Rect~%# opencv Rect data type, x-y is center point~%float64 x~%float64 y~%float64 width~%float64 height~%~%~%~%"))
