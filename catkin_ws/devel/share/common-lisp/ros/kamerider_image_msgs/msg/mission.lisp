...
(cl:defmethod cl:initialize-instance :after ((m <mission>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mission)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kamerider_image_msgs-msg:<mission> is deprecated: use kamerider_image_msgs-msg:mission instead.")))

(cl:ensure-generic-function 'mission_type-val :lambda-list '(m))
(cl:defmethod mission_type-val ((m <mission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kamerider_image_msgs-msg:mission_type-val is deprecated.  Use kamerider_image_msgs-msg:mission_type instead.")
  (mission_type m))

(cl:ensure-generic-function 'mission_name-val :lambda-list '(m))
(cl:defmethod mission_name-val ((m <mission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kamerider_image_msgs-msg:mission_name-val is deprecated.  Use kamerider_image_msgs-msg:mission_name instead.")
  (mission_name m))
