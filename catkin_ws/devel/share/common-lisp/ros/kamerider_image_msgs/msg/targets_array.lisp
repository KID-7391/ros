...
(cl:defclass <targets_array> (roslisp-msg-protocol:ros-message)
  ((targets
    :reader targets
    :initarg :targets
    :type (cl:vector kamerider_image_msgs-msg:pixel_index)
   :initform (cl:make-array 0 :element-type 'kamerider_image_msgs-msg:pixel_index :initial-element (cl:make-instance 'kamerider_image_msgs-msg:pixel_index))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <targets_array>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'targets_array)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kamerider_image_msgs-msg:<targets_array> is deprecated: use kamerider_image_msgs-msg:targets_array instead.")))

(cl:ensure-generic-function 'targets-val :lambda-list '(m))
(cl:defmethod targets-val ((m <targets_array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kamerider_image_msgs-msg:targets-val is deprecated.  Use kamerider_image_msgs-msg:targets instead.")
  (targets m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <targets_array>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'targets)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'kamerider_image_msgs-msg:pixel_index))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<targets_array>)))
  ...
  "kamerider_image_msgs/targets_array")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'targets_array)))
  "Returns string type for a message object of type 'targets_array"
  "kamerider_image_msgs/targets_array")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<targets_array>)))
  ...
  (cl:format cl:nil "pixel_index[] targets~%~%================================================================================~%MSG: kamerider_image_msgs/pixel_index~%int32 x~%int32 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'targets_array)))
  "Returns full string definition for message of type 'targets_array"
  (cl:format cl:nil "pixel_index[] targets~%~%================================================================================~%MSG: kamerider_image_msgs/pixel_index~%int32 x~%int32 y~%~%~%"))
