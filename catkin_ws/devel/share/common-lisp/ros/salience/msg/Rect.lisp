...
(cl:defmethod cl:initialize-instance :after ((m <Rect>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rect)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name salience-msg:<Rect> is deprecated: use salience-msg:Rect instead.")))

(cl:ensure-generic-function 'x0-val :lambda-list '(m))
(cl:defmethod x0-val ((m <Rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader salience-msg:x0-val is deprecated.  Use salience-msg:x0 instead.")
  (x0 m))

(cl:ensure-generic-function 'y0-val :lambda-list '(m))
(cl:defmethod y0-val ((m <Rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader salience-msg:y0-val is deprecated.  Use salience-msg:y0 instead.")
  (y0 m))

(cl:ensure-generic-function 'x1-val :lambda-list '(m))
(cl:defmethod x1-val ((m <Rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader salience-msg:x1-val is deprecated.  Use salience-msg:x1 instead.")
  (x1 m))

(cl:ensure-generic-function 'y1-val :lambda-list '(m))
(cl:defmethod y1-val ((m <Rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader salience-msg:y1-val is deprecated.  Use salience-msg:y1 instead.")
  (y1 m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader salience-msg:id-val is deprecated.  Use salience-msg:id instead.")
  (id m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Rect>)))
  ...
  "e6d557464a0baf5174b255c2c5be2036")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Rect)))
  "Returns md5sum for a message object of type 'Rect"
  "e6d557464a0baf5174b255c2c5be2036")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Rect>)))
  ...
  (cl:format cl:nil "# opencv Rect data type, x-y is center point~%float64 x0~%float64 y0~%float64 x1~%float64 y1~%int32 id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Rect)))
  "Returns full string definition for message of type 'Rect"
  (cl:format cl:nil "# opencv Rect data type, x-y is center point~%float64 x0~%float64 y0~%float64 x1~%float64 y1~%int32 id~%~%~%"))
