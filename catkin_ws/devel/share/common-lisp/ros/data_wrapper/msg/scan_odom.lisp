...
;//! \htmlinclude scan_odom.msg.html

(cl:defclass <scan_odom> (roslisp-msg-protocol:ros-message)
  ((scan
    :reader scan
    :initarg :scan
...
(cl:defclass scan_odom (<scan_odom>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <scan_odom>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'scan_odom)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name data_wrapper-msg:<scan_odom> is deprecated: use data_wrapper-msg:scan_odom instead.")))

(cl:ensure-generic-function 'scan-val :lambda-list '(m))
(cl:defmethod scan-val ((m <scan_odom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader data_wrapper-msg:scan-val is deprecated.  Use data_wrapper-msg:scan instead.")
  (scan m))

(cl:ensure-generic-function 'odom-val :lambda-list '(m))
(cl:defmethod odom-val ((m <scan_odom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader data_wrapper-msg:odom-val is deprecated.  Use data_wrapper-msg:odom instead.")
  (odom m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <scan_odom>) ostream)
  "Serializes a message object of type '<scan_odom>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <scan_odom>) istream)
  "Deserializes a message object of type '<scan_odom>"
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <scan_odom>))
